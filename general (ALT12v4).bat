...
start "zapret: %~n0" /min "%BIN%winws.exe" --wf-tcp=80,443,853,2053,2083,2087,2096,8443,25565,%GameFilterTCP% --wf-udp=443,19294-19344,50000-50100,53,%GameFilterUDP% ^
...
--filter-udp=443 --hostlist="%LISTS%list-google.txt" --hostlist="%LISTS%list-general.txt" --hostlist-exclude="%LISTS%list-exclude.txt" --hostlist-exclude="%LISTS%list-exclude-user.txt" ^
--dpi-desync=fake ^
